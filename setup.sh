...
export TURBINE_COASTER_CONFIG="jobManager=local,provider=local,maxParallelTasks=64,workerLoggingLevel=DEBUG,workerLoggingDirectory=/home/jake/test/workerlogs"
